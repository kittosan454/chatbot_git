...
def wellness_question_data(): # 카테고리와 질문만 받는다.
  root_path = "../data"
...
def wellness_answer_data(): # 카테고리와 답변을 묶는다.
  root_path = "../data"
  wellness_file = root_path + "/wellness_dialog_dataset.xlsx"
...
def wellness_dialog_for_autoregressive(): # 질문과 답변 셋을 만든다
  root_path = "../data"
  wellness_file = root_path + "/wellness_dialog_dataset.xlsx"
